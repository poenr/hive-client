...
if [ ! -f "flink-1.10.1-bin-scala_2.11.tgz" ];then
wget -c http://dl.software.dc/dist/flink-1.10.1-bin-scala_2.11.tgz
fi
...
tar xvf flink-1.10.1-bin-scala_2.11.tgz -C /opt/flink/ && \
